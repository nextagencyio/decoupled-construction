...
export const metadata: Metadata = {
  title: 'Projects | Ironstone Construction',
  description: 'Browse our portfolio of commercial, residential, and industrial construction projects.',
}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-200 max-w-3xl mx-auto">
              Explore our portfolio of completed construction projects across commercial, residential, and industrial sectors.
            </p>
          </div>
        </div>
      </section>
