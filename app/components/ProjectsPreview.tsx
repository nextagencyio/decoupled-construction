      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="font-display text-3xl md:text-4xl font-bold text-primary-900 mb-4">Featured Projects</h2>
          </div>
              ...
              <div className="relative h-48 bg-gray-100">
                {item.image?.url ? (
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-gradient-to-br from-primary-100 to-accent-100">
                    <Wrench className="w-12 h-12 text-primary-300" />
                  </div>
                )}
              </div>
              <div className="p-6">
                {item.location && (
                  <p className="text-sm font-bold text-primary-700 mb-1">{item.location}</p>
                )}
