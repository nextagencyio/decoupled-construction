...
export const metadata: Metadata = {
  title: 'Testimonials | Ironstone Construction',
  description: 'Read what our clients say about working with Ironstone Construction.',
}
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-primary-200 max-w-3xl mx-auto">
              Hear from the clients who trust us with their most important projects.
            </p>
          </div>
        </div>
      </section>
